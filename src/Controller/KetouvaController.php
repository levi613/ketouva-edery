...
class KetouvaController extends AbstractController
{
    ...
    public function generateWord($modele, Ketouva $ketouva, PdfGeneratorService $pdfGenerator, CreateKetouva $createKetouva): Response
    {
        $text = $createKetouva->genereTextKetouva($ketouva);
        ...
        // $modeleWord = new TemplateProcessor($this->getParameter('kernel.project_dir') . '/public/assets/modele/modele' . $modele . '.docx');
        ...
        $text = str_replace('<span style="font-size:130%">', '', $text);
